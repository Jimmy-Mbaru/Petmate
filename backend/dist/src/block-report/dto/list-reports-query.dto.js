...
__decorate([
    ...
    __metadata("design:type", Number)
], ListReportsQueryDto.prototype, "offset", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: ['PENDING', 'REVIEWED', 'DISMISSED'] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['PENDING', 'REVIEWED', 'DISMISSED']),

/**
 * Seed script to create approved boarding profiles for testing
 * Run with: npx ts-node scripts/seed-boarding.ts
 */
...
async function getOrCreateHost(email: string, name: string, password: string) {
